                        ...
                        <div className="row gx-5 align-items-center justify-content-center">
                            <div className="col-lg-8 col-xl-7 col-xxl-6">
                                <div className="my-5 text-center text-xl-start">
                                    <h1 className="display-5 fw-bolder text-white mb-2">Electric Vehicle Smart Meter</h1>
                                    <p className="lead fw-normal text-white-50 mb-4">Charge you vehicle by just one tap, Anytime and Anywhere.</p>
                                    <div className="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                        <a className="btn btn-dark btn-lg px-4 me-sm-3" href="/signup">Register Now</a>
