...
const Withdraw = ({token}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const { data, error } = await supabase
      ...
      const previousBalance = data[0]?.amount;
    ...
    const { data3, error3} = await supabase
      .from('transactions')
      .insert({ email: token.user.email, amount: balance, date_and_time: now, upi: upi, d_or_w: 'Withdrawed'})
    ...
    alert('Amount is withdrawed from you wallet successfully.')
    navigate('/wallet')
                    ...
                    <div className="card-body py-5 px-md-5">
                        ...
                        <div className="row d-flex justify-content-center">
                            <div className="col-lg-8">
                                <h2 className="fw-bold mb-5">Withdraw</h2>
